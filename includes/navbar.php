...
<header class="header-container noselect">
	...
	<div class="header-bottom-slide-up" >
		<div class="login-wrap">
				<style> .hidden{display:none}</style>
				<form id="Slider" class="hidden"  action="login.php" method="POST">
					<input name="user_name" type="text" class="text-input" name="email" placeholder="Enter your email" value="" />
					<input name="user_password" type="password" name="password" placeholder="Password" value="" />
